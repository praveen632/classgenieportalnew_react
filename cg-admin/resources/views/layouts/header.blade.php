...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo $url;?>/home" class="logo">
      ...
      <span class="logo-mini">{{Html::image('public/images/logo-white.png')}}</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">{{Html::image('public/images/logo-white.png')}}<strong>Classgenie</strong></span>
    </a>
