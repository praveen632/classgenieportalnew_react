        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Content Management</h3>&nbsp&nbsp<button type="button" class="btn btn-success search_btn-add" onclick="editContent(this.id)" id="new"><b><strong>Add New</strong></b></button></div>
              <div class="col-md-12">
