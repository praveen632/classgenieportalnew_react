...
<div class="box">
  <div class="box-header">
    <h3 class="box-title">Student Image Magement</h3>&nbsp;&nbsp;<a class="btn btn-success search_btn-add" href="<?php echo url('/imagemanagement/student/create')?>">Add Student Image</a>
  </div>
  {!! csrf_field() !!}
   <div class="col-md-12">
