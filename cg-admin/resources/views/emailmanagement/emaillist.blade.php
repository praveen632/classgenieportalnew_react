        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-header" class="panel-heading col-md-12" >
               <div class="col-md-6">    
              <h3 class="box-title">Email Management</h3>&nbsp&nbsp<button type="button" class="btn btn-success search_btn-add" onclick="editEmailContent(this.id)" id="new"><b><strong>Add New</strong></b></button></div> 
            <!-- /.box-header -->          
